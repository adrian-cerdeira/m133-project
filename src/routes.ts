...
router.get('/', (req, res) => {
    res.render('html/index', { products: products, total: cart.getTotal() });
});
...
router.get('/checkout', (req, res) => {
    res.render('html/checkout', { total: cart.getTotal() });
});
...
router.get('/products/:id', (req, res) => {
    ...
    res.render('html/product', { product: selectedProduct, total: cart.getTotal() });
});
